...
<body>
    ...
    <?php 
        ...
        */
        ...
        echo "<br>";
        echo "Array sisa baginya adalah:  " . print_r($hasilBagi); 
        echo "<br>";
        ...
        */
        ...
        $item = ["id" => "001", "name" => "Keyboard Logitek", "price" => 60000, "description" => "Keyboard yang mantap untuk kantoran", "source" => "logitek.jpeg", "id" => "002", "name" => "Keyboard MSI", "price" => 300000, "description" => "Keyboard gaming MSI mekanik", "source" => "msi.jpeg"];
